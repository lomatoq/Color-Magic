<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/assets/color-magic-logo-dark.webp">
    <source media="(prefers-color-scheme: light)" srcset="docs/assets/color-magic-logo-light.webp">
    <img src="docs/assets/color-magic-logo-light.webp" width="480" height="467" alt="Color Magic">
  </picture>
</p>
...
![Workflow](docs/assets/workflow-en.svg)

## In Blender

Tripo moped with an orthographic camera, soft Key / Fill / Rim studio lighting and 23 preserved zones.

![Tripo moped · Workspace](docs/assets/tripo-workspace.png)

<details>
<summary>Fast Track</summary>

![Tripo moped · Fast Track](docs/assets/tripo-fast-track.png)
...
metallic Accent hardware (Metallic 1.0, Roughness 0.26). Only gold is Fixed.
The sample is included in the install ZIP.
